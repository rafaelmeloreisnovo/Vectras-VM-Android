...
typedef enum {
  RMR_QEMU_PRESET_BALANCED = RMR_ZERO_QEMU_PRESET_BALANCED_U8,
  RMR_QEMU_PRESET_PERFORMANCE = RMR_ZERO_QEMU_PRESET_PERFORMANCE_U8,
  RMR_QEMU_PRESET_COMPATIBILITY = RMR_ZERO_QEMU_PRESET_COMPATIBILITY_U8
} RmR_QemuPreset;

typedef enum {
  RMR_GUEST_ARCH_X86_64 = RMR_ZERO_QEMU_GUEST_ARCH_X86_64_U8,
  RMR_GUEST_ARCH_I386 = RMR_ZERO_QEMU_GUEST_ARCH_I386_U8,
  RMR_GUEST_ARCH_ARM64 = RMR_ZERO_QEMU_GUEST_ARCH_ARM64_U8,
  RMR_GUEST_ARCH_PPC = RMR_ZERO_QEMU_GUEST_ARCH_PPC_U8
} RmR_GuestArch;
