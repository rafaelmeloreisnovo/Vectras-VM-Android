...
## Documentos ativos
- [`VECTRA_MULTILINGUAL_INVARIANT_OPERATIONAL_CYCLES.md`](VECTRA_MULTILINGUAL_INVARIANT_OPERATIONAL_CYCLES.md): contrato operacional para organizar conteúdo multidisciplinar/multilíngue, dois ciclos de execução, invariantes, failover, rollback e token vazio.
